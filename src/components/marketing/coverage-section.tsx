...
export function CoverageSection() {
  return (
    ...
    >
      <div className="site-container flex flex-col gap-10 px-6 py-12 md:px-10 wide:grid wide:h-[512px] wide:grid-cols-coverage wide:items-center wide:gap-14 wide:px-20 wide:py-14">
