...
export function AppDownloadSection() {
  return (
    ...
    >
      <div className="flex w-full flex-col gap-10 px-6 py-12 md:px-10 wide:grid wide:h-[716px] wide:grid-cols-[560px_minmax(0,1fr)] wide:items-center wide:gap-20 wide:px-20 wide:py-14">
        ...
        <div className="relative flex min-w-0 justify-center wide:h-full">
          <Image
            ...
            className="h-auto w-full max-w-[500px] wide:absolute wide:top-[-110px] wide:left-1/2 wide:h-[960px] wide:w-[628px] wide:max-w-none wide:-translate-x-1/2"
          />
        </div>
      </div>
    </section>
