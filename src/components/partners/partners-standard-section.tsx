import { partnerPrinciples } from "@/constants/partners-content";

export function PartnersStandardSection() {
  return (
    <section
      id="trux-standard"
      aria-labelledby="partners-standard-heading"
      className="bg-white px-6 py-16 text-midnight md:px-10 wide:h-[780px] wide:p-20"
    >
      <div className="mx-auto flex w-full max-w-[1352px] flex-col gap-12 wide:gap-16">
        <div className="flex max-w-[800px] flex-col gap-4 wide:gap-6">
          <h2
            id="partners-standard-heading"
